...
interface ConditionsNotificationCardProps {
	notification: notificationType;
	handleDelete: (id: number) => void;
}

const ConditionsNotificationCard = ({ notification, handleDelete }: ConditionsNotificationCardProps): JSX.Element => {
	...
	return (
		<>
			<HeaderNotificationCard
				...
				title={t("screens.notifications.conditions.title")}
...
export default ConditionsNotificationCard;
